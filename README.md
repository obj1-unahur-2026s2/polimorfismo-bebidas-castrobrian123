...
* **Cianuro**: el cianuro no favorece al rendimiento, sino que el deportista, luego de consumirlo queda como muerto, llenos de abulia y de marasmo. Con cianuro, el rendimiento es siempre 0 (cero) si el peso del deportista es 70 o menos. Si es mas de 70 1% del peso + la dosis consumida.
...
Agregar a pepe, otro voluntario, que pesa inicialmente 80, tiene 30 años. pepe debe poner cumplir años y se diferencia de tito en que para calcular su velocidad si tiene mas de 30 entonces le resta 10 de velocidad
